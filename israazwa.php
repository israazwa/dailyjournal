...
<head>
    ...
    <title>My Daily Journal | israazwa</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
                    <li class="nav-item">
                        <a class="nav-link" href="israazwa.php?page=dashboard">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="israazwa.php?page=article">Article</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="israazwa.php?page=gallery">Gallery</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="israazwa.php?page=profil">Profil
